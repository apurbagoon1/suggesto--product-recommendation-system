        ...
        <div>
            ...
            <div className="max-w-5xl mx-auto px-4 py-10">
                <div className="text-center mt-4 mb-8">
                    ...
                    <p className="md:text-lg tracking-wider">Get a deeper look into the concerns, reasons, and recommendations for this product.</p>
                </div>
                <div className="bg-gradient-to-r from-orange-300 via-orange-200 to-orange-300 shadow-lg rounded p-4">
                    ...
                    <div className='space-y-5 p-6'>
                        <h2 className="text-xl md:text-2xl font-bold text-orange-500">{query.QueryTitle}</h2>
